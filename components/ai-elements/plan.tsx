...
// `render` and `style` are dropped rather than forwarded: both are typed
// against the CollapsibleTrigger's state and cannot be handed to the Button
// underneath, whose state is a different shape.
