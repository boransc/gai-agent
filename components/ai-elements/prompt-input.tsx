...
/**
 * base-ui hands handlers its own event wrapper (the DOM event plus
 * `preventBaseUIHandler`). Deriving the parameter types from the components
 * keeps these signatures correct across base-ui versions.
 */
