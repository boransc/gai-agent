...
function AgentMessagePart({
  ...
  switch (part.type) {
    ...
    case "dynamic-tool": {
      // The eligibility tool returns structured quote data; render it as a
      // quote rather than letting the generic tool view show raw JSON.
      if (
        part.toolName === "check_job_eligibility" &&
